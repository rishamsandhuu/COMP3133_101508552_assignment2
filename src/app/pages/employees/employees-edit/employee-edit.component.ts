      ...
      <mat-card class="form-card">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <div class="upload-section">
            <label class="upload-label">Replace Profile Picture</label>
          ...
          <div class="actions">
            <button mat-stroked-button type="button" [routerLink]="['/employees/view', eid]">
              View
            </button>
...
export class EmployeeEditComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.employeeService.updateEmployeeByEid(this.eid, {
      ...raw,
      ...
      next: (response) => {
        this.snackBar.open(response.message || 'Employee updated successfully', 'Close', {
          duration: 3000,
        });
        this.router.navigate(['/employees/view', this.eid]);
      },
      error: (error) => {
        this.loading = false;
        const message =
